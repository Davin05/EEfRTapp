...
class StartPage(tk.Frame):
    def __init__(self, master):
        ...
        lbl = tk.Label(subFrame,
                       text = "Welcome To EEfRT Experiment!", font = tkFont.Font(size= master.font_size()))
        lbl.grid(row = 0, column = 0)
        lbl2 = tk.Label(subFrame,
                        text = "thank you for participating", font  = tkFont.Font(size = (master.font_size() - 5)))
...
class EndPage(tk.Frame):
    def __init__(self, master):
        ...
        lbl = tk.Label(subFrame,
                       text="Congratulation, you have completed all of the trails!", font=tkFont.Font(size= master.font_size()))
        lbl.grid(row=0, column=0)
        lbl2 = tk.Label(subFrame,
                        text="thank you for participating", font=tkFont.Font(size= (master.font_size() - 5)))
        lbl2.grid(row=1, column=0)
