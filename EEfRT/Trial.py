...
class TrialChoose(tk.Frame):
    def __init__(self, master):
        ...
        lbl2 = tk.Label(subFrame,
                        text=f"probability of win: {probability_generator(master)}%", font=tkFont.Font(size=(master.font_size() - 10)))
...
class CompleteStatusPage(tk.Frame):
    def __init__(self, master):
        ...
        lbl = tk.Label(subFrame,
                       text = f"You {self.status_to_string()} the task!", font = tkFont.Font(size= master.font_size()))
        lbl.grid(row = 0, column = 0)
...
class WinningStatusPage(tk.Frame):
    def __init__(self, master):
        ...
        lbl = tk.Label(subFrame,
                       text= f"{self.status_to_string()}", font=tkFont.Font(size=master.font_size()))
        lbl.grid(row=0, column=0)
